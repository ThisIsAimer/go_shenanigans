...
const file_proto_main_proto_rawDesc = "" +
	...
	"\tCalculate\x126\n" +
	"\x03Add\x12\x16.calculater.AddRequest\x1a\x17.calculater.AddResponseB\x13Z\x11/proto/gen;mainpbb\x06proto3"
...
var file_proto_main_proto_depIdxs = []int32{
	...
	1, // 1: calculater.Calculate.Add:output_type -> calculater.AddResponse
